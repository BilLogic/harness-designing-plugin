...
- [`article-quote-finder-corpus.md`](article-quote-finder-corpus.md) — default corpus for `article-quote-finder` (Substack article series locations + section anchors)
