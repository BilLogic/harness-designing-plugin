...
description: "Clusters docs/knowledge/lessons/ and scores each cluster for rule-readiness (Layer 5 → AGENTS.md rule). Use from hd:maintain propose-rule and hd:review audit drift."
color: purple
model: inherit
---
